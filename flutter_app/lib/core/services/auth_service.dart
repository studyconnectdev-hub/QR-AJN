...
class AuthService extends ChangeNotifier {
  ...
  Future<bool> signIn(String email, String password) async {
    ...
    return _run(() => FirebaseAuth.instance.signInWithEmailAndPassword(
          email: email.trim(),
          password: password,
        ));
  }
  ...
  Future<bool> register(String email, String password) async {
    if (!available) return false;
    return _run(() => FirebaseAuth.instance.createUserWithEmailAndPassword(
          email: email.trim(),
          password: password,
        ));
  }
  ...
  Future<bool> deleteAccount(String password) async {
    ...
    try {
      ...
      if (current == null || email == null) {
        throw FirebaseAuthException(code: 'no-email-account', message: 'This account cannot be deleted from this sign-in method yet.');
      }
