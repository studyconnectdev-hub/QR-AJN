...
class _GeneratorDetailScreenState extends State<GeneratorDetailScreen> {
  ...
  Future<void> _copyPayload(String payload) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('QR content copied.')),
    );
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(children: [
              ...
              Expanded(child: OutlinedButton.icon(onPressed: payload.isEmpty ? null : () => _copyPayload(payload), icon: const Icon(Icons.copy_rounded), label: const Text('Copy'))),
            ]),
            const SizedBox(height: 10),
            Row(children: [
