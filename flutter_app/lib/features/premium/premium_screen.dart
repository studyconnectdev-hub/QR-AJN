...
class PremiumScreen extends StatelessWidget {
          ...
          child: ListView(
            ...
            children: [
              ...
              if (premium.products.isEmpty) ...[
                ...
                _PlanCard(
                  title: 'QR AJN Business',
                  subtitle: 'Business profiles, templates and dynamic QR management',
  ...
  static String _titleFor(String id) {
    ...
    return 'QR AJN Business';
  }

  static String _subtitleFor(String id) {
    if (id == AppConfig.businessMonthlyId) return 'Business profiles, dynamic QR and team-ready tools';
    if (id == AppConfig.premiumYearlyId) return 'Best value • all Pro features for one year';
